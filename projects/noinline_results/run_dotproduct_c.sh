...
if [[ "$RUNS" -eq 1 ]]; then
  ls -1 "results_c(O0).csv" "results_c(O1).csv" "results_c(O2).csv" "results_c(O3).csv"
else
  ls -1 \
    "results_c(O0).csv" "results_c(O1).csv" "results_c(O2).csv" "results_c(O3).csv" \
    "results_c(O0)_mean.csv" "results_c(O1)_mean.csv" "results_c(O2)_mean.csv" "results_c(O3)_mean.csv" \
    "results_c(O0)_median.csv" "results_c(O1)_median.csv" "results_c(O2)_median.csv" "results_c(O3)_median.csv"
fi
